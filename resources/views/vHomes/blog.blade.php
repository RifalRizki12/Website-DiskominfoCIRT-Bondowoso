...
<head>
    ...
    <title>Informasi List - Diskominfo</title>
        ...
        <nav class="navbar">
          ...
          <div class="logo">
            <a data-toggle="collapse" data-target=".navbar-collapse.show" class="navbar-brand" href="{{route('/')}}">
              <!-- Logo White Starts -->
              <img id="logo-light" class="logo-light" src="/images/logo/logocirt.png" alt="logo-light" />
              <!-- Logo White Ends -->
              <!-- Logo Black Starts -->
                ...
                <article>
                  ...
                  <figure>
                    <a href="{{route('site.single.post',$post->slug)}}">
                      <img class="img-responsive" src="{{$post->thumbnail()}}" alt="" style="max-width:50%;">
                    </a>
                  </figure>
                  <!-- Figure Ends -->
                  <!-- Excerpt Starts -->
