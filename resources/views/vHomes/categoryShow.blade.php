...
<head>
	...
	<title>Kategori {{$category2->name}}</title>
    <!-- Favicon -->
			...
			<div class="content text-center">
				<div class="text-center top-text">
					...
					<div class="text-center top-text">
						...
						<h3 style="color: white"><strong>{{$category2->name}} Kategori</strong></h3>
					</div> 
					<!-- Main Heading Ends -->
					<hr>
                    <!-- Breadcrumb Starts -->
							...
							@if ($post->status != 'nonaktif')
								...
								<article>
									...
									<div class="meta">
										...
										<span><i class="fa fa-tags"></i>{{$category2->name}}</span>
									</div>
									<!-- Meta Ends -->
								</article>
								<!-- Article Ends -->
					...
					<div class="sidebar col-xs-12 col-md-4">
						...
						<div class="widget widget-tags">
							...
							<ul class="unstyled clearfix">
								@foreach ($tags as $tag)
									<li>
										<a href="{{route('tagShow',[$tag->id])}}">{{$tag->name}}
											{{-- ({{$tag->posts()->count()}}) --}}
										</a>
									</li>	
								@endforeach
