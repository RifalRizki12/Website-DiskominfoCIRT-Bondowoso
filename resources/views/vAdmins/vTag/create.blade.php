        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" style="text-align: center">Masukkan Tag</h4><br><br>
                            <div class="row">
                                <div class="col-md-8">
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group btn-group-example" role="group">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm w-xs" >
                                            <a href="{{route('editTag',[$show->id])}}" style="color: white">
                                                <i class="mdi mdi-account-edit"> Edit</i>
                                            </a>
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm w-xs">
                                            <a href="{{route('deleteTag',[$show->id])}}" style="color: white" onclick="return confirm('Yakin')">
