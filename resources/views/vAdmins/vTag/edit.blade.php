...
@section('title','Edit Tag - Diskominfo')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="text-align: center">Edit Tag</h4><br><br>

                            <form action="{{route('updateTag',[$tag->id])}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}

                                <div class="form-group row">
                                    <label for="name" class="col-md-2 col-form-label">Nama</label>
                                    <div class="col-md-10">
                                        <input name="name" class="form-control" type="text" value="{{$tag->name}}" id="name" required>
                                    </div>
                                </div>
