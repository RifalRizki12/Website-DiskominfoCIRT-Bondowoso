                ...
                <div class="col-xl-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <h5 class="font-size-15 text-truncate">{{auth()->user()->datadiri->nama_depan}} {{auth()->user()->datadiri->nama_belakang}}</h5>
                                    <p class="text-muted mb-0 text-truncate">{{auth()->user()->datadiri->jenis_kelamin}}</p>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">Hai Nama Saya {{auth()->user()->datadiri->nama_depan}} {{auth()->user()->datadiri->nama_belakang}}, saya lahir pada {{auth()->user()->datadiri->tanggal_lahir}}.</p>
                            <div class="table-responsive">
                                <table class="table table-nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            <th scope="row">Full Name :</th>
                                            <td>{{auth()->user()->datadiri->nama_depan}} {{auth()->user()->datadiri->nama_belakang}}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row">No Hp :</th>
                                            <td>{{auth()->user()->datadiri->nohp}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{auth()->user()->datadiri->alamat}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
